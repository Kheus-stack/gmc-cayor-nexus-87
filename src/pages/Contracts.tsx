import { FileText, Plus, Download, Upload, User, Home, FileCheck, Shield } from "lucide-react"
  ...
  const [contracts, setContracts] = useState<Contract[]>([
    {
      ...
      locataire_telephone: "+221 77 123 45 67",
      locataire_email: "jean.dupont@email.com",
      locataire_piece_type: "CIN",
      locataire_piece_numero: "1234567890123",
      type_bien: "Appartement",
      adresse: "15 Rue de la Paix, Dakar",
      superficie: 75,
      nombre_pieces: 3,
      usage: "Habitation",
      ...
      preavis_mois: 2,
      charges: ["Eau", "Sécurité"],
      date_etat_lieux: "2024-01-14",
      equipements: ["Climatiseur", "Chauffe-eau"],
      etat_general: "Bon",
      assurance_exigee: true,
      reparations_charge: "Locataire",
      observations: "Contrat standard",
    ...
    },
    {
      ...
      locataire_telephone: "+221 78 987 65 43",
      locataire_email: "marie.martin@email.com",
      locataire_piece_type: "Passeport",
      locataire_piece_numero: "P9876543",
      type_bien: "Villa",
      adresse: "22 Avenue Bourguiba, Fann",
      superficie: 200,
      nombre_pieces: 5,
      usage: "Habitation",
      loyer_mensuel: 850000,
      depot_garantie: 1700000,
      duree_contrat: "2 ans",
      date_debut: "2024-03-01",
      renouvellement_auto: false,
      preavis_mois: 3,
      charges: ["Eau", "Électricité", "Sécurité"],
      date_etat_lieux: "2024-02-29",
      equipements: ["Climatiseur", "Meubles", "Gazinière"],
      etat_general: "Excellent",
      assurance_exigee: true,
      reparations_charge: "Partagées",
      observations: "Villa meublée avec jardin",
              ...
              <TableBody>
                {contracts.map((contract) => (
                  <TableRow key={contract.id}>
                    <TableCell className="font-medium">{contract.property_id}</TableCell>
                    <TableCell>{contract.locataire_nom}</TableCell>
                    ...
                    <TableCell>{getDateFin(contract.date_debut, contract.duree_contrat).toLocaleDateString()}</TableCell>
                    <TableCell>{getStatusBadge(contract.date_debut, contract.duree_contrat)}</TableCell>
                    <TableCell>
                      {contract.fichier ? (
